...
class CoachProfile(Base):
    ...
    subscriptions: Mapped[list["Subscription"]] = relationship(back_populates="coach", cascade="all, delete-orphan")
...
class ClientProfile(Base):
    ...
    user: Mapped["User"] = relationship(foreign_keys=[user_id], back_populates="client_profile")
    streak: Mapped["Streak"] = relationship(back_populates="client", uselist=False, cascade="all, delete-orphan")
    progress_entries: Mapped[list["ProgressEntry"]] = relationship(back_populates="client", cascade="all, delete-orphan")
    supplement_logs: Mapped[list["SupplementLog"]] = relationship(back_populates="client", cascade="all, delete-orphan")
    attendance_records: Mapped[list["Attendance"]] = relationship(back_populates="client", cascade="all, delete-orphan")
    weekly_goals: Mapped[list["WeeklyGoal"]] = relationship(back_populates="client", cascade="all, delete-orphan")
