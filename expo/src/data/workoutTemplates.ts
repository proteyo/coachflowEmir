    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            exerciseId: "lib_triceps_close_grip_barbell_bench_press",
            sets: 3,
            reps: 8,
            restSeconds: 90,
...
const EXTRA_WORKOUT_TEMPLATES: WeeklyTrainingPlan[] = [
  ...
  buildPlan({
    id: "recomposition_intermediate_3x",
    title: "Body Recomposition System",
    subtitle: "Build muscle and lose fat at the same time",
    goal: "recomposition",
    goalLabel: "Body recomposition",
    description:
      "A professional 3-day plan for clients who want to improve body composition: keep or build muscle while slowly reducing fat. It combines heavy compound lifts, hypertrophy accessories and controlled cardio without turning every session into exhaustion.",
    level: "intermediate",
    equipment: "gym",
    sessionsPerWeek: 3,
    estimatedMinutesPerSession: 65,
    tags: ["recomposition", "muscle retention", "fat loss", "strength base"],
    coachAnalysis:
      "This plan works best for clients who are not complete beginners and can follow nutrition consistently. The structure protects muscle through progressive strength work while adding enough energy expenditure through short conditioning blocks.",
    safetyNotes: [
      "Do not turn every cardio block into an all-out sprint.",
      "Main lifts should stay at RPE 7–8, not maximal attempts.",
      "If sleep or recovery drops, reduce cardio before reducing strength work.",
    ],
    progressionNotes: [
      "Track body weight trend, waist measurements and working weights together.",
      "If strength is stable and waist decreases, the plan is working.",
      "Increase load only after all prescribed reps are completed with clean technique.",
    ],
    days: [
      {
        id: "recomposition_day_1",
        dayOffset: 0,
        name: "Day 1 · Strength + Upper Push",
        description:
          "Main strength day with pressing work and a short controlled cardio finish.",
        category: "Recomposition",
        durationMinutes: 65,
        exercises: [
          { exerciseId: "lib_chest_barbell_bench_press", sets: 4, reps: 6, restSeconds: 150, notes: "Main lift. Keep 1–2 reps in reserve.", targetRpe: 8 },
          { exerciseId: "lib_chest_incline_dumbbell_press", sets: 3, reps: 10, restSeconds: 90, notes: "Upper chest hypertrophy with full control.", targetRpe: 8 },
          { exerciseId: "lib_back_seated_cable_rows", sets: 4, reps: 10, restSeconds: 75, notes: "Balance pressing volume with strong rowing.", targetRpe: 8 },
          { exerciseId: "lib_shoulders_side_lateral_raise", sets: 3, reps: 15, restSeconds: 45, notes: "Shoulder width and extra calorie burn through density.", targetRpe: 8 },
          { exerciseId: "lib_triceps_rope_pushdown", sets: 3, reps: 12, restSeconds: 45, notes: "Controlled isolation, no swinging.", targetRpe: 8 },
          { exerciseId: "lib_cardio_bicycling_stationary", sets: 1, reps: 12, restSeconds: 0, notes: "Moderate finish. Client should not be destroyed after it.", targetRpe: 7 },
        ],
      },
      {
        id: "recomposition_day_2",
        dayOffset: 2,
        name: "Day 2 · Lower Body Muscle Retention",
        description:
          "Lower-body strength and hypertrophy to keep muscle while body fat decreases.",
        category: "Lower body",
        durationMinutes: 68,
        exercises: [
          { exerciseId: "lib_legs_barbell_squat", sets: 4, reps: 6, restSeconds: 150, notes: "Strong but clean squat work.", targetRpe: 8 },
          { exerciseId: "lib_glutes_romanian_deadlift", sets: 4, reps: 8, restSeconds: 120, notes: "Hip hinge for posterior chain and muscle retention.", tempo: "3-1-1", targetRpe: 8 },
          { exerciseId: "lib_legs_leg_press", sets: 3, reps: 12, restSeconds: 90, notes: "Controlled range, no bouncing.", targetRpe: 8 },
          { exerciseId: "lib_legs_lying_leg_curls", sets: 3, reps: 12, restSeconds: 60, notes: "Hamstring support for knees and hips.", targetRpe: 8 },
          { exerciseId: "lib_abs_dead_bug", sets: 3, reps: 10, restSeconds: 30, notes: "Core stability before cardio finish.", targetRpe: 6 },
          { exerciseId: "lib_cardio_rowing_stationary", sets: 1, reps: 10, restSeconds: 0, notes: "Full-body steady conditioning.", targetRpe: 7 },
        ],
      },
      {
        id: "recomposition_day_3",
        dayOffset: 4,
        name: "Day 3 · Pull + Metabolic Density",
        description:
          "Back-dominant session with enough training density to support fat loss.",
        category: "Pull",
        durationMinutes: 62,
        exercises: [
          { exerciseId: "lib_back_pullups", sets: 4, reps: 8, restSeconds: 120, notes: "Use assistance if needed. Full control.", targetRpe: 8 },
          { exerciseId: "lib_back_bent_over_barbell_row", sets: 4, reps: 8, restSeconds: 120, notes: "Heavy row, neutral spine.", targetRpe: 8 },
          { exerciseId: "lib_back_wide_grip_lat_pulldown", sets: 3, reps: 12, restSeconds: 75, notes: "Lat width and pulling volume.", targetRpe: 8 },
          { exerciseId: "lib_shoulders_face_pull", sets: 3, reps: 15, restSeconds: 45, notes: "Rear delts and shoulder health.", targetRpe: 7 },
          { exerciseId: "lib_biceps_alternate_hammer_curl", sets: 3, reps: 12, restSeconds: 45, notes: "Arm work without excessive fatigue.", targetRpe: 8 },
          { exerciseId: "lib_cardio_mountain_climbers", sets: 6, reps: 30, restSeconds: 30, notes: "30 seconds work. Keep hips stable.", targetRpe: 8 },
        ],
      },
    ],
  }),
  buildPlan({
    id: "endurance_engine_3x",
    title: "Endurance Engine",
    subtitle: "Build stamina without losing strength",
    goal: "endurance",
    goalLabel: "Endurance",
    description:
      "A 3-day endurance plan that develops the client’s aerobic base, muscular endurance and breathing control. Strength is maintained with moderate compound work, while cardio volume is added progressively.",
    level: "intermediate",
    equipment: "mixed",
    sessionsPerWeek: 3,
    estimatedMinutesPerSession: 55,
    tags: ["endurance", "conditioning", "stamina", "mixed"],
    coachAnalysis:
      "Use this plan for clients who get tired quickly, need better stamina, or want to prepare for sport and active lifestyle goals. It is structured to improve endurance without making the client feel broken every session.",
    safetyNotes: [
      "Breathing should be hard but controlled during steady cardio.",
      "Do not add running volume too fast if the client has knee, ankle or shin issues.",
      "Keep technique clean during high-rep strength work.",
    ],
    progressionNotes: [
      "Increase cardio duration by 5 minutes only after the client completes the week comfortably.",
      "Track resting heart rate, breathing and recovery quality.",
      "Keep at least one low-intensity day between harder conditioning sessions.",
    ],
    days: [
      {
        id: "endurance_day_1",
        dayOffset: 0,
        name: "Day 1 · Aerobic Base + Full Body",
        description:
          "Low-to-moderate intensity base work with simple full-body strength.",
        category: "Endurance",
        durationMinutes: 55,
        exercises: [
          { exerciseId: "lib_cardio_bicycling_stationary", sets: 1, reps: 20, restSeconds: 0, notes: "Steady zone 2 style pace. Reps represent minutes.", targetRpe: 6 },
          { exerciseId: "lib_legs_leg_press", sets: 3, reps: 15, restSeconds: 60, notes: "Muscular endurance for legs.", targetRpe: 7 },
          { exerciseId: "lib_chest_pushups", sets: 3, reps: 12, restSeconds: 45, notes: "Use incline if needed.", targetRpe: 7 },
          { exerciseId: "lib_back_seated_cable_rows", sets: 3, reps: 15, restSeconds: 60, notes: "Controlled high-rep rowing.", targetRpe: 7 },
          { exerciseId: "lib_abs_dead_bug", sets: 3, reps: 12, restSeconds: 30, notes: "Breathing and core control.", targetRpe: 6 },
        ],
      },
      {
        id: "endurance_day_2",
        dayOffset: 2,
        name: "Day 2 · Interval Conditioning",
        description:
          "Short intervals to improve conditioning without excessive impact.",
        category: "Conditioning",
        durationMinutes: 50,
        exercises: [
          { exerciseId: "lib_cardio_rowing_stationary", sets: 6, reps: 45, restSeconds: 45, notes: "45 seconds hard, 45 seconds easy/rest.", targetRpe: 8 },
          { exerciseId: "lib_glutes_bodyweight_walking_lunge", sets: 3, reps: 12, restSeconds: 60, notes: "12 reps per leg. Smooth pace.", targetRpe: 7 },
          { exerciseId: "lib_shoulders_dumbbell_shoulder_press", sets: 3, reps: 12, restSeconds: 60, notes: "Moderate load, clean reps.", targetRpe: 7 },
          { exerciseId: "lib_abs_air_bike", sets: 3, reps: 20, restSeconds: 30, notes: "Controlled rotation, no neck pulling.", targetRpe: 7 },
          { exerciseId: "lib_stretching_childs_pose", sets: 2, reps: 60, restSeconds: 15, notes: "Downshift breathing after intervals.", targetRpe: 2 },
        ],
      },
      {
        id: "endurance_day_3",
        dayOffset: 4,
        name: "Day 3 · Long Easy Cardio + Mobility",
        description:
          "Longer low-intensity cardio to build stamina and recovery capacity.",
        category: "Endurance",
        durationMinutes: 60,
        exercises: [
          { exerciseId: "lib_cardio_elliptical_trainer", sets: 1, reps: 30, restSeconds: 0, notes: "Easy-to-moderate steady pace. Reps represent minutes.", targetRpe: 6 },
          { exerciseId: "lib_back_bodyweight_mid_row", sets: 3, reps: 12, restSeconds: 60, notes: "Posture support after cardio.", targetRpe: 6 },
          { exerciseId: "lib_glutes_butt_lift_bridge", sets: 3, reps: 20, restSeconds: 45, notes: "Glute activation and hip support.", targetRpe: 6 },
          { exerciseId: "lib_stretching_kneeling_hip_flexor", sets: 2, reps: 45, restSeconds: 15, notes: "Seconds per side.", targetRpe: 3 },
          { exerciseId: "lib_stretching_standing_hamstring_calf", sets: 2, reps: 45, restSeconds: 15, notes: "Posterior chain cooldown.", targetRpe: 3 },
        ],
      },
    ],
  }),
  buildPlan({
    id: "posture_back_corrective_3x",
    title: "Posture & Back Corrective",
    subtitle: "Upper back, core and posture support",
    goal: "posture_back",
    goalLabel: "Posture & back",
    description:
      "A corrective-style plan for clients with weak upper back, rounded shoulders or sedentary posture. It strengthens pulling muscles, teaches core control and adds mobility for shoulders and hips.",
    level: "beginner",
    equipment: "mixed",
    sessionsPerWeek: 3,
    estimatedMinutesPerSession: 45,
    tags: ["posture", "back", "corrective", "mobility"],
    coachAnalysis:
      "This plan is not medical rehab, but it gives the coach a safe structure for posture-focused fitness clients. The priority is quality, scapular control, breathing and gradual strengthening.",
    safetyNotes: [
      "Avoid heavy spinal loading if the client reports back pain.",
      "Movements should reduce tension, not create sharp pain.",
      "Keep all rows controlled and avoid shrugging into the neck.",
    ],
    progressionNotes: [
      "First progress control and range of motion, then load.",
      "Add weight to rows only when the client can keep shoulders down and back.",
      "Use weekly photos or posture notes to track visible changes.",
    ],
    days: [
      {
        id: "posture_back_day_1",
        dayOffset: 0,
        name: "Day 1 · Upper Back Foundation",
        description:
          "Scapular control, rows and gentle shoulder mobility.",
        category: "Posture",
        durationMinutes: 45,
        exercises: [
          { exerciseId: "lib_stretching_round_world_shoulder", sets: 2, reps: 10, restSeconds: 15, notes: "Gentle shoulder range before strength work.", targetRpe: 3 },
          { exerciseId: "lib_back_seated_cable_rows", sets: 4, reps: 12, restSeconds: 60, notes: "Pause with shoulder blades back, avoid shrugging.", targetRpe: 7 },
          { exerciseId: "lib_shoulders_face_pull", sets: 4, reps: 15, restSeconds: 45, notes: "Rear delts and external rotation focus.", targetRpe: 7 },
          { exerciseId: "lib_back_straight_arm_pulldown", sets: 3, reps: 12, restSeconds: 45, notes: "Lat control without elbow bending.", targetRpe: 7 },
          { exerciseId: "lib_abs_dead_bug", sets: 3, reps: 10, restSeconds: 30, notes: "Ribs down, lower back controlled.", targetRpe: 6 },
        ],
      },
      {
        id: "posture_back_day_2",
        dayOffset: 2,
        name: "Day 2 · Core & Hip Support",
        description:
          "Core stability and hip mobility to reduce posture compensation.",
        category: "Core",
        durationMinutes: 42,
        exercises: [
          { exerciseId: "lib_stretching_cat_stretch", sets: 3, reps: 10, restSeconds: 15, notes: "Spine mobility with slow breathing.", targetRpe: 3 },
          { exerciseId: "lib_glutes_butt_lift_bridge", sets: 4, reps: 15, restSeconds: 45, notes: "Glute activation to support pelvis position.", targetRpe: 6 },
          { exerciseId: "lib_abs_ab_roller", sets: 3, reps: 8, restSeconds: 60, notes: "Use shorter range if lower back arches.", targetRpe: 7 },
          { exerciseId: "lib_stretching_kneeling_hip_flexor", sets: 3, reps: 45, restSeconds: 15, notes: "Seconds per side. Do not overextend lower back.", targetRpe: 3 },
          { exerciseId: "lib_stretching_childs_pose", sets: 2, reps: 60, restSeconds: 15, notes: "Relaxed breathing cooldown.", targetRpe: 2 },
        ],
      },
      {
        id: "posture_back_day_3",
        dayOffset: 4,
        name: "Day 3 · Pull Strength & Mobility",
        description:
          "Back strength, rear delts and mobility for long-term posture support.",
        category: "Back",
        durationMinutes: 48,
        exercises: [
          { exerciseId: "lib_back_wide_grip_lat_pulldown", sets: 3, reps: 12, restSeconds: 60, notes: "Pull to upper chest, keep neck relaxed.", targetRpe: 7 },
          { exerciseId: "lib_back_one_arm_dumbbell_row", sets: 3, reps: 10, restSeconds: 75, notes: "10 reps per side. Keep torso stable.", targetRpe: 7 },
          { exerciseId: "lib_shoulders_bent_over_rear_delt_raise", sets: 3, reps: 15, restSeconds: 45, notes: "Light weight, strict rear delt control.", targetRpe: 7 },
          { exerciseId: "lib_shoulders_arm_circles", sets: 2, reps: 20, restSeconds: 15, notes: "Easy shoulder movement after strength.", targetRpe: 3 },
          { exerciseId: "lib_stretching_standing_hamstring_calf", sets: 2, reps: 45, restSeconds: 15, notes: "Posterior chain cooldown.", targetRpe: 3 },
        ],
      },
    ],
  ...
  buildPlan({
    id: "upper_body_shape_3x",
    title: "Upper Body Shape",
    subtitle: "Shoulders, back, chest and arms",
    goal: "upper_body",
    goalLabel: "Upper body",
    description:
      "A balanced upper-body plan for clients who want stronger shoulders, back, chest and arms while keeping lower-body fatigue low. It is useful for physique goals, posture and upper-body confidence.",
    level: "intermediate",
    equipment: "gym",
    sessionsPerWeek: 3,
    estimatedMinutesPerSession: 60,
    tags: ["upper body", "shoulders", "back", "arms", "shape"],
    coachAnalysis:
      "The plan balances push and pull volume so shoulders stay healthy. It gives enough frequency for upper-body development without ignoring posture and scapular control.",
    safetyNotes: [
      "Warm up shoulders before pressing.",
      "Do not overload lateral raises with swinging.",
      "If shoulder pain appears, reduce pressing and increase face pulls/rows.",
    ],
    progressionNotes: [
      "Progress presses slowly and isolation exercises through reps first.",
      "Keep pull volume equal to or slightly higher than pressing volume.",
      "Track shoulder comfort and pump quality, not only weight lifted.",
    ],
    days: [
      {
        id: "upper_body_day_1",
        dayOffset: 0,
        name: "Day 1 · Chest & Back Balance",
        description:
          "Push-pull session that builds chest and back together.",
        category: "Upper body",
        durationMinutes: 60,
        exercises: [
          { exerciseId: "lib_chest_barbell_bench_press", sets: 4, reps: 8, restSeconds: 120, notes: "Main press, stable setup.", targetRpe: 8 },
          { exerciseId: "lib_back_seated_cable_rows", sets: 4, reps: 10, restSeconds: 90, notes: "Match pressing volume with rows.", targetRpe: 8 },
          { exerciseId: "lib_chest_incline_dumbbell_press", sets: 3, reps: 10, restSeconds: 75, notes: "Upper chest and controlled stretch.", targetRpe: 8 },
          { exerciseId: "lib_back_wide_grip_lat_pulldown", sets: 3, reps: 12, restSeconds: 75, notes: "Lat width and posture.", targetRpe: 8 },
          { exerciseId: "lib_shoulders_face_pull", sets: 3, reps: 15, restSeconds: 45, notes: "Shoulder health finish.", targetRpe: 7 },
        ],
      },
      {
        id: "upper_body_day_2",
        ...
        description:
          "Shoulder shape, arms and rear delts with controlled isolation volume.",
        category: "Shoulders & arms",
        durationMinutes: 58,
        exercises: [
          { exerciseId: "lib_shoulders_dumbbell_shoulder_press", sets: 4, reps: 8, restSeconds: 90, notes: "Main shoulder press.", targetRpe: 8 },
          { exerciseId: "lib_shoulders_side_lateral_raise", sets: 4, reps: 15, restSeconds: 45, notes: "Side delts for shoulder width.", targetRpe: 8 },
          { exerciseId: "lib_shoulders_bent_over_rear_delt_raise", sets: 3, reps: 15, restSeconds: 45, notes: "Rear delts and posture.", targetRpe: 8 },
          { exerciseId: "lib_biceps_barbell_curl", sets: 3, reps: 10, restSeconds: 60, notes: "Strict biceps work.", targetRpe: 8 },
          { exerciseId: "lib_triceps_rope_pushdown", sets: 3, reps: 12, restSeconds: 45, notes: "Triceps isolation, full extension.", targetRpe: 8 },
        ],
      },
      {
        id: "upper_body_day_3",
        dayOffset: 4,
        name: "Day 3 · Back Width + Chest Detail",
        description:
          "Back width, upper chest and arms for a complete upper-body week.",
        category: "Upper body",
        durationMinutes: 62,
        exercises: [
          { exerciseId: "lib_back_pullups", sets: 4, reps: 8, restSeconds: 120, notes: "Use assistance if needed. Full range.", targetRpe: 8 },
          { exerciseId: "lib_chest_dumbbell_flyes", sets: 3, reps: 12, restSeconds: 60, notes: "Controlled stretch. Do not go too deep.", targetRpe: 7 },
          { exerciseId: "lib_back_t_bar_row", sets: 4, reps: 8, restSeconds: 90, notes: "Back thickness and strong posture.", targetRpe: 8 },
          { exerciseId: "lib_chest_cable_crossover", sets: 3, reps: 15, restSeconds: 45, notes: "Chest detail with smooth control.", targetRpe: 8 },
          { exerciseId: "lib_biceps_alternate_hammer_curl", sets: 2, reps: 12, restSeconds: 45, notes: "Biceps and forearm finish.", targetRpe: 8 },
          { exerciseId: "lib_triceps_bench_dips", sets: 2, reps: 12, restSeconds: 45, notes: "Use only if shoulders feel comfortable.", targetRpe: 7 },
        ],
      },
    ],
  }),
...
const AUTO_LOCALIZATION: Record<string, PlanLocalization> = {
  ...
  recomposition_intermediate_3x: {
    titleRu: "Система рекомпозиции тела",
    titleKk: "Дене рекомпозициясы жүйесі",
    subtitleRu: "Набор мышц и снижение жира одновременно",
    subtitleKk: "Бұлшықет өсіріп, майды азайту",
    goalLabelRu: "Рекомпозиция тела",
    goalLabelKk: "Дене рекомпозициясы",
    descriptionRu: "Профессиональный план на 3 дня для улучшения композиции тела: сохранить или набрать мышцы и постепенно снижать процент жира. Внутри — силовая база, гипертрофия и контролируемое кардио без изматывания.",
    descriptionKk: "Дене құрамын жақсартуға арналған 3 күндік кәсіби жоспар: бұлшықетті сақтап немесе өсіріп, майды біртіндеп азайту. Ішінде күш базасы, гипертрофия және бақылаулы кардио бар.",
    coachAnalysisRu: "Лучше всего подходит клиентам, которые уже не совсем новички и готовы соблюдать питание. Силовая часть защищает мышцы, а короткие кондиционные блоки помогают расходу энергии.",
    coachAnalysisKk: "Мүлде жаңа емес және тамақтануды ұстай алатын клиенттерге жақсы. Күш бөлігі бұлшықетті қорғайды, ал қысқа кондиция блоктары энергия шығынын арттырады.",
    dayRu: ["День 1 · Сила + жимовой верх", "День 2 · Низ тела и сохранение мышц", "День 3 · Тяга + плотность работы"],
    dayKk: ["1-күн · Күш + итеру жоғарғы дене", "2-күн · Төменгі дене және бұлшықет сақтау", "3-күн · Тарту + жұмыс тығыздығы"],
    dayDescriptionRu: ["Силовая тренировка с жимовым акцентом и коротким кардио-финишем.", "Низ тела для сохранения мышц на фоне снижения жира.", "Тяговая тренировка с плотностью работы для поддержки жиросжигания."],
    dayDescriptionKk: ["Жимге екпін беретін күш жаттығуы және қысқа кардио аяқтау.", "Май азайған кезде бұлшықетті сақтауға арналған төменгі дене.", "Май азайтуға көмектесетін тығыз тарту жаттығуы."],
  },
  endurance_engine_3x: {
    titleRu: "Двигатель выносливости",
    titleKk: "Төзімділік қозғалтқышы",
    subtitleRu: "Выносливость без потери силы",
    subtitleKk: "Күшті жоғалтпай төзімділікті арттыру",
    goalLabelRu: "Выносливость",
    goalLabelKk: "Төзімділік",
    descriptionRu: "План на 3 дня для развития аэробной базы, мышечной выносливости и контроля дыхания. Силовая работа сохраняется, а кардио добавляется постепенно.",
    descriptionKk: "Аэробты база, бұлшықет төзімділігі және тыныс бақылауын дамытуға арналған 3 күндік жоспар. Күш жұмысы сақталады, кардио біртіндеп қосылады.",
    coachAnalysisRu: "Используй для клиентов, которые быстро устают, хотят лучше держать нагрузку или готовятся к активному образу жизни и спорту.",
    coachAnalysisKk: "Тез шаршайтын, жүктемені жақсы ұстағысы келетін немесе спорт пен белсенді өмірге дайындалатын клиенттерге қолдан.",
    dayRu: ["День 1 · Аэробная база + всё тело", "День 2 · Интервальная кондиция", "День 3 · Долгое лёгкое кардио + мобильность"],
    dayKk: ["1-күн · Аэробты база + толық дене", "2-күн · Интервалды кондиция", "3-күн · Ұзақ жеңіл кардио + қозғалыс"],
    dayDescriptionRu: ["Низко-средняя интенсивность и простая силовая работа на всё тело.", "Короткие интервалы для улучшения формы без чрезмерной ударной нагрузки.", "Длинное лёгкое кардио для развития выносливости и восстановления."],
    dayDescriptionKk: ["Төмен-орта қарқын және толық денеге қарапайым күш жұмысы.", "Артық соққы жүктемесінсіз форманы жақсартатын қысқа интервалдар.", "Төзімділік пен қалпына келуді жақсартатын ұзақ жеңіл кардио."],
  },
  posture_back_corrective_3x: {
    titleRu: "Осанка и здоровая спина",
    titleKk: "Қалып және сау арқа",
    subtitleRu: "Верх спины, корпус и поддержка осанки",
    subtitleKk: "Жоғарғы арқа, корпус және қалып қолдауы",
    goalLabelRu: "Осанка и спина",
    goalLabelKk: "Қалып және арқа",
    descriptionRu: "Корректирующий фитнес-план для слабого верха спины, округлённых плеч и сидячей осанки. Укрепляет тяговые мышцы, корпус и добавляет мобильность.",
    descriptionKk: "Жоғарғы арқасы әлсіз, иығы алға түскен және көп отыратын клиенттерге арналған түзету фитнес жоспары. Тарту бұлшықеттерін, корпусты күшейтеді және қозғалысты қосады.",
    coachAnalysisRu: "Это не медицинская реабилитация, но безопасная структура для клиентов с фокусом на осанку: качество, лопатки, дыхание и постепенное укрепление.",
    coachAnalysisKk: "Бұл медициналық реабилитация емес, бірақ қалыпқа бағытталған клиенттерге қауіпсіз құрылым: сапа, жауырын бақылауы, тыныс және біртіндеп күшею.",
    dayRu: ["День 1 · База верха спины", "День 2 · Корпус и таз", "День 3 · Сила тяги и мобильность"],
    dayKk: ["1-күн · Жоғарғы арқа базасы", "2-күн · Корпус және жамбас", "3-күн · Тарту күші және қозғалыс"],
    dayDescriptionRu: ["Контроль лопаток, тяги и мягкая мобильность плеч.", "Стабильность корпуса и мобильность таза для уменьшения компенсаций.", "Сила спины, задние дельты и мобильность для долгосрочной поддержки осанки."],
    dayDescriptionKk: ["Жауырын бақылауы, тарту және иыққа жеңіл қозғалыс.", "Компенсацияны азайтуға арналған корпус тұрақтылығы және жамбас қозғалысы.", "Қалыпты ұзақ қолдау үшін арқа күші, артқы дельта және қозғалыс."],
  },
  upper_body_shape_3x: {
    titleRu: "Форма верхней части тела",
    titleKk: "Жоғарғы дене пішіні",
    subtitleRu: "Плечи, спина, грудь и руки",
    subtitleKk: "Иық, арқа, кеуде және қол",
    goalLabelRu: "Верх тела",
    goalLabelKk: "Жоғарғы дене",
    descriptionRu: "Сбалансированный план для развития плеч, спины, груди и рук при низкой усталости ног. Подходит для формы, осанки и уверенности в верхней части тела.",
    descriptionKk: "Аяқты қатты шаршатпай иық, арқа, кеуде және қолды дамытуға арналған теңгерімді жоспар. Пішін, қалып және жоғарғы денеге сенімділік үшін жақсы.",
    coachAnalysisRu: "План балансирует жим и тягу, чтобы плечи оставались здоровыми. Частота достаточная для развития верха тела и поддержки осанки.",
    coachAnalysisKk: "Иық сау болуы үшін жоспар итеру мен тартуды теңестіреді. Жоғарғы денені дамытуға және қалыпты қолдауға жиілік жеткілікті.",
    dayRu: ["День 1 · Баланс груди и спины", "День 2 · Плечи и руки", "День 3 · Ширина спины + детали груди"],
    dayKk: ["1-күн · Кеуде мен арқа балансы", "2-күн · Иық және қол", "3-күн · Арқа ені + кеуде деталі"],
    dayDescriptionRu: ["Жимово-тяговая тренировка для груди и спины.", "Плечи, руки и задние дельты с контролируемой изоляцией.", "Ширина спины, верх груди и руки для полноценной недели верха."],
    dayDescriptionKk: ["Кеуде мен арқаны бірге дамытатын итеру-тарту жаттығуы.", "Иық, қол және артқы дельтаға бақылаулы оқшаулау.", "Жоғарғы дененің толық аптасы үшін арқа ені, жоғарғы кеуде және қол."],
  },
  busy_45min_3x: {
